...
export const Route = createFileRoute("/_authenticated/following")({
  ...
  head: () => ({
    meta: [
      { title: "Following — StoryWeaver" },
      { name: "description", content: "Updates from creators and series you follow." },
    ],
  }),
});
    ...
    <PageShell>
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-2 text-muted-foreground">
          New chapters, live games, and canon updates from the worlds you follow.
        </p>
        ...
        {data.length === 0 ? (
          <div className="mt-10 rounded-xl border border-border bg-card p-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Follow creators and series to build your personal feed.
            </p>
              ...
              >
                {item.type === "chapter" ? (
                  ...
                  <>
                    ...
                    <p className="mt-1 font-medium">
                      {(item as Extract<typeof item, { type: "bible" }>).name}
                    </p>
